...
<?php
	...
	$nombre=$_POST["nomb"];
        ...
        $sql = "SELECT * FROM siec_uni_medida WHERE um_nombre = '" .$nombre. "' and um_id_um !='" .$id. "' ;";
...
$query_check_user=mysqli_num_rows($query_check_user_name);     
		...
		$sql="UPDATE siec_uni_medida SET um_nombre='".$nombre."',um_descripcion	= '".$des."' WHERE enf_id_enfermedad='".$id."'";
		$query_update = mysqli_query($mysqli,$sql);
			...
			if ($query_update){
              ...
              $errors []= "ya existe esta unidad de medida"; 
             }
